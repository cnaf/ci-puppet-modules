class storm_repos ($repo_scope = 'develop') {
  ...
  case $lsbmajdistrelease {
    5       : {
      $storm_repo_file = "puppet:///modules/storm_repos/storm_${repo_scope}_sl5.repo"
      $storm_repo_file_src = "puppet:///modules/storm_repos/storm_${repo_scope}_sl5_src.repo"
    }
    6       : {
      $storm_repo_file = "puppet:///modules/storm_repos/storm_${repo_scope}_sl6.repo"
      $storm_repo_file_src = "puppet:///modules/storm_repos/storm_${repo_scope}_sl6_src.repo"
    }
