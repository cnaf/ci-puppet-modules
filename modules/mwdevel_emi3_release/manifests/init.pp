class mwdevel_emi3_release {
  ...
  exec { 'import-emi3-gpg-key': command => 'rpm --import http://emisoft.web.cern.ch/emisoft/dist/EMI/3/RPM-GPG-KEY-emi', }
  ...
  exec { 'yum clean all': require => Exec['emi3-package-install'], }
